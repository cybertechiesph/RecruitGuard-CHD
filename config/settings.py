...
INTERNAL_MFA_ENABLED = env_bool("INTERNAL_MFA_ENABLED", True)
if not DEBUG and not INTERNAL_MFA_ENABLED:
    raise ImproperlyConfigured("INTERNAL_MFA_ENABLED cannot be disabled when DJANGO_DEBUG is False.")
