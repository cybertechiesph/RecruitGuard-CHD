...
| 7 | Examination Management | In Progress | Exam records, controlled CHD selection-plan exam/admin/result fields, structured technical/general and practical/general ability components, 40/60 weighted scores, exam date/administered-by fields, optional Evidence Vault support, validity/waiver handling, finalization lock, exam tests; pending manual review |
